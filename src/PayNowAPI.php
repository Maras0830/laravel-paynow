...
class PayNowAPI extends PayNowSOAP
{
    ...
    public function __construct()
    {
        if (config('paynow.debug_mode') === true) {
            $this->client = new SoapClient('http://test.paynow.com.tw/PayNowAPI.asmx?wsdl', array('soap_version' => SOAP_1_2, 'trace' => true));
        }
        else {
            $this->client = new SoapClient('https://www.paynow.com.tw/PayNowAPI.asmx?wsdl', array('soap_version' => SOAP_1_2, 'trace' => true));
        }
